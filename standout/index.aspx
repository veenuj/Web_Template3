...
<nav id="menu" class="navbar navbar-default navbar-fixed-top">
  <div class="container"> 
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand page-scroll" href="#page-top">ANUJ DHIMAN</a> </div>
...
<header id="header">
  <div class="intro">
    <div class="overlay">
      <div class="container">
        <div class="row">
          <div class="intro-text"> <span>I'M </span>
            <h1>Anuj</h1>
            <p>I'M A CREATIVE WEB DEVELOPER</p>
              <p>I STAND ON A SWEET SPOT WHERE</p>
              <p>DESIGN & CODE</p>
              <p>INTERSECTS</p>
    ...
    <div class="row">
      ...
      <div class="col-xs-12 col-md-6">
        <div class="about-text">
          ...
          <p>1.Dotnet , web designning ,web applications,C# , C++ , JavaScript, CSS, JQuery</p>
          <p>2.TEAM LEADER, PROJECT MANAGER, WORKED AS TEAM MEMBER TOO.</p>
            <p>3.SCHOOL ERP, COLLEGE ERP, BILLING SOFTWARE, ADMINISTRATION SOFTWARE, JEWELLERY SOFTWARE.</p>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-xs-6 col-md-3"> <i class="fa fa-group"></i>
        <h4>ADMINISTRATIVE APPLICATION</h4>
        <p>Lorem ipsum dolor sit amet placerat facilisis felis mi in tempus eleifend pellentesque natoque etiam.</p>
      </div>
    ...
    <div class="row">
      <div class="col-md-8 col-md-offset-2">
        <div id="testimonial" class="owl-carousel owl-theme">
          <div class="item"> <img src="img/clients/anuj.png" alt=""/>
            ...
            <p><strong>MR. ANUJ DHIMAN</strong>, CEO, Company.</p>
          </div>
          <div class="item"> <img src="img/clients/anuj.png" alt=""/>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis sed dapibus leo nec ornare diam. Sed commodo nibh ante facilisis bibendum dolor feugiat at duis sed dapibus leo nec ornare diam.</p>
            <p><strong>MRS. UVW</strong>, CEO, Company.</p>
          </div>
          <div class="item"> <img src="img/clients/anuj.png" alt=""/>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis sed dapibus leo nec ornare diam. Sed commodo nibh ante facilisis bibendum dolor feugiat at duis sed dapibus leo nec ornare diam.</p>
            <p><strong> MR. XYZ</strong>, CEO, Company.</p>
          </div>
        </div>
      </div>
    </div>
...
<div id="footer">
  <div class="container text-center">
    <p>Copyright &copy; ANUJ 2020 . Designed by ANUJ DHIMAN</p>
  </div>
</div>
